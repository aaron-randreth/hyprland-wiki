...
If your `XDG_CURRENT_DESKTOP` environment variable is not set to "Hyprland", the fade out will be disabled and the value of your `no_fade_out` variable will be ignored.
